...
def run_reg_loop(test_df, train_df, regs, grid, label_col): 
    ...
    for r, model in regs.iteritems(): 
        ...
        for p in ParameterGrid(parameter_values): 
            ...
            evaluator = RegressionEvaluator(scores, y_test)
            evaluation_table.append([c, p] + evaluator.all_metrics()) 
